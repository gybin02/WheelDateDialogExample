...
package com.seeker.datedialog.widget.wheel.abs;
 ...
 * 
 * <p>
 * See {@link ListView}, {@link GridView}, {@link Spinner} and {@link WheelGallery} for commonly used
 * subclasses of AdapterView.
 */
public abstract class WheelAdapterView<T extends Adapter> extends ViewGroup {
    ...
    public WheelAdapterView(Context context) {
        super(context);
    }

    public WheelAdapterView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public WheelAdapterView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(WheelAdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(WheelAdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemDoubleClickListener {
         ...
         * @return true if the callback consumed the long click, false otherwise
         */
        boolean onItemDoubleClick(WheelAdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(WheelAdapterView<?> parent, View view, int position, long id);
         ...
         */
        void onNothingSelected(WheelAdapterView<?> parent);
    }
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (WheelAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null && mOldItemCount == 0
                    && mItemCount > 0) {
                WheelAdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (WheelAdapterView.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = WheelAdapterView.this.onSaveInstanceState();
            }
