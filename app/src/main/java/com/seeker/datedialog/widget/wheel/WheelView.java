...
/**
 * WheelView 视图，支持自定义AdapterView实现。用法同Galery
 * @author zhengxiaobin <gybin02@Gmail.com>
 * @since  2016/4/13 21:26
 */
public class WheelView extends WheelGallery {
    ...
    private void initialize(Context context) {
        ...
        this.setOrientation(WheelGallery.VERTICAL);
...
//        drawShadows(canvas);
    ...
    public void setOrientation(int orientation) {
        if (WheelGallery.HORIZONTAL == orientation) {
    ...
    private int linePaintColor = 0xff999999; // 分割线颜色
