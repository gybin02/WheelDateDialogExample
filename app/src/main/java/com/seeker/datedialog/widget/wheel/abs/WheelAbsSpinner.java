 ...
 */
public abstract class WheelAbsSpinner extends WheelAdapterView<SpinnerAdapter> {
    ...
    public WheelAbsSpinner(Context context) {
        super(context);
        initAbsSpinner();
    }

    public WheelAbsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WheelAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initAbsSpinner();

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.WheelAbsSpinner, defStyle, 0);

        CharSequence[] entries = a.getTextArray(R.styleable.WheelAbsSpinner_entries);
        if (entries != null) {
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        /**
         * Constructor called from {@link WheelAbsSpinner#onSaveInstanceState()}
         */
