 ...
 * 
 * Gallery 支持水平和垂直， 支持 循环
 */
public class WheelGallery extends WheelAbsSpinner implements GestureDetector.OnGestureListener,
    ...
    public WheelGallery(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.galleryStyle);
    }

    public WheelGallery(Context context, AttributeSet attrs, int defStyle) {
